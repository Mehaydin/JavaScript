...
// Kareköklerini bulma
let karekokler = sayilar.map(sayi => Math.sqrt(sayi));
...
let enKucuk = Math.min(...sayilar); // pread operatörü, Math.max ve Math.min fonksiyonlarına array içindeki elemanları ayrı ayrı argümanlar olarak geçirmek için kullanılır.
